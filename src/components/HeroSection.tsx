    ...
    <section ref={targetRef} className="mt-[calc(var(--navbar-height)+100px)] h-[400vh] relative">
      <div className="sticky top-[calc(var(--navbar-height)+100px)] py-3 text-center overflow-hidden">
        <h1 className="font-times text-center">
          ...
          <span className="font-allura block text-[clamp(6rem,20vw,192px)] leading-none mt-8 relative z-10 select-none">
            Crunsh
          </span>
        </h1>
        <motion.div style={{ x }} className="absolute left-16 sm:left-44 right-0 top-10 sm:top-0 flex items-center gap-[18vw] w-full px-4 pointer-events-none">
          <Image
